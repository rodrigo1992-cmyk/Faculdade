...
-- Copiar uma das tabelas citadas. 

CREATE TABLE Clientes_bkp AS SELECT * FROM Clientes;

-- Executar uma consulta (com todas as colunas) para a tabela copiada. 

SELECT * FROM Clientes_bkp;

ALTER TABLE Clientes_bkp RENAME TO Tabela_Renomeada_Clientes_bkp;
